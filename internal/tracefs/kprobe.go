...
var getTracefsPath = internal.Memoize(func() (string, error) {
	for _, p := range []struct {
		...
		{"/proc/1/root/sys/kernel/tracing", unix.TRACEFS_MAGIC},
		{"/proc/1/root/sys/kernel/debug/tracing", unix.TRACEFS_MAGIC},
		// RHEL/CentOS
		{"/proc/1/root/sys/kernel/debug/tracing", unix.DEBUGFS_MAGIC},
	} {
